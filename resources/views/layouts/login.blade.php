                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Lembrar minhas
                                                    credenciais</label>
                                            </div>
                                        </div>
                                        <a href="/vigep-admin" class="btn btn-primary btn-user btn-block">
                                            Entrar
                                        </a>
                                        <hr>
                                    </form>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="#">Falar com o administrador.</a>
                                    </div>
                                </div>
                            </div>
                        </div>
