                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">12 de Dezembro de 2023</div>
                                        <span class="font-weight-bold">Existem uma ficha que foi solicitada correção,
                                            por favor corrija o quanto antes!</span>
                                    </div>
                                </a>

                                <a class="dropdown-item text-center small text-gray-500" href="#">Mostrar-me todos
                                    os alertas</a>
                            </div>
                        </li>
